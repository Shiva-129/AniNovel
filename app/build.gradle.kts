...
android {
    ...
    defaultConfig {
        applicationId = "xyz.shouko.aninovel"
...
dependencies {
    ...
    implementation(aninovlibs.compose.constraintlayout)
    implementation(androidx.corektx)
    implementation(androidx.splashscreen)
    implementation(androidx.recyclerview)
    implementation(androidx.viewpager)
    implementation(androidx.profileinstaller)
    implementation(aninovlibs.mediasession)
    ...
    // mpv-android
    implementation(aninovlibs.mpv)
    // FFmpeg-kit
    implementation(aninovlibs.ffmpeg.kit)
    implementation(aninovlibs.arthenica.smartexceptions)
    // seeker seek bar
    implementation(aninovlibs.seeker)
    // true type parser
    implementation(aninovlibs.truetypeparser)
}
