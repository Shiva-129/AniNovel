...
import eu.kanade.tachiyomi.ui.browse.novel.NovelBrowseTab
...
private data object NovelBrowseTabWrapper : Tab {
    override val options: TabOptions
        @Composable get() = NovelBrowseTab.options

    @Composable
    override fun Content() = NovelBrowseTab.Content()
}
...
enum class NavStyle(
    ...
    val tabs: List<Tab>
        get(): List<Tab> {
            return mutableListOf<Tab>(
                AnimeLibraryTab,
                MangaLibraryTab,
                NovelBrowseTabWrapper,
                UpdatesTab,
                HistoriesTab,
                BrowseTab,
                MoreTab,
