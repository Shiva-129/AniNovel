...
data object BrowseTab : Tab {
    ...
    override fun Content() {
        ...
        val novelSourcesScreenModel = rememberScreenModel { NovelSourcesScreenModel() }
        val novelSourcesState by novelSourcesScreenModel.state.collectAsState()

        val tabs = persistentListOf(
            animeSourcesTab(),
            mangaSourcesTab(),
            novelSourcesTab(novelSourcesScreenModel),
        ...
        TabbedScreen(
            ...
            novelSearchQuery = novelSourcesState.searchQuery ?: novelExtensionsState.searchQuery,
            onChangeNovelSearchQuery = { query ->
                novelSourcesScreenModel.search(query)
                novelExtensionsScreenModel.search(query)
            },
            scrollable = true,
        )
        LaunchedEffect(Unit) {
