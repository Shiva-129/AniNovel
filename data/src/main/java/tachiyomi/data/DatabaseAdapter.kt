...
object NovelDownloadStateColumnAdapter : ColumnAdapter<tachiyomi.data.novel.model.NovelDownloadState, Long> {
    override fun decode(databaseValue: Long): tachiyomi.data.novel.model.NovelDownloadState =
        tachiyomi.data.novel.model.NovelDownloadState.entries.getOrElse(databaseValue.toInt()) {
            tachiyomi.data.novel.model.NovelDownloadState.NOT_DOWNLOADED
        }

    override fun encode(value: tachiyomi.data.novel.model.NovelDownloadState): Long = value.ordinal.toLong()
}
